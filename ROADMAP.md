...
### Recently Completed
- 2026-07-09: fix(analysis): enforce area_m2 == geometry.area after SAM refine + posthoc merge
- 2026-07-05: fix(postproc): D5 ruling — unify conf/elong tier semantics to first-match (#6)
